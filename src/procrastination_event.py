...
class FocusPopup:
    def __init__(self, master, ai_message, pledge_message):
        ...
        self.ai_message_label = tk.Label(
            ...
            bg="white",
            fg="black",
            wraplength=self.master.winfo_screenwidth()
            - 100,  # Wrap text to fit the screen width with padding
        )
        ...
        self.label = tk.Label(
            self.bottom_frame,
            text="Please type the following to continue working:",
            font=("Helvetica", 18),
            bg="white",
            fg="black",
        )
        ...
        self.result_label = tk.Label(
            self.bottom_frame, text="", font=("Helvetica", 16), bg="white", fg="black"
        )
    ...
    def check_input(self, event):
        ...
        if user_input == self.challenge_text:
            ...
            self.result_label.config(
                text="Incorrect input. Please try again.", fg="red"
            )
...
if __name__ == "__main__":
    ...
    procrastination_event.show_popup(
        "You are procrastinating. Please focus on your work.",
